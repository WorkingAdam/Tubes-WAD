...
<div class="content-wrapper">
      ...
      <div class="row">
          ...
          <a class="btn btn-tool" href="{{route('admin.diamond.create')}}"> <i class="fas fa-plus"> </i> Add </a>
          
          <a class="btn btn-tool" href="{{route('admin.diamond')}}"> <i class="fas fa-undo"> </i> Back </a>  
                  ...
                  <tr>
                    ...
                    <td style="text-align: center;">
						<form action="{{ route('admin.layanan.destroy',$dt->id) }}" method="POST">
                    		<a class="btn btn-info btn-xs" href="{{ route('admin.diamond.edit',$dt->id) }}"><i class="fas fa-pencil-alt"> </i> Edit</a>
							@csrf
							@method('DELETE')

...
<head>
  ...
  <title>Fellastore | <?php echo $judul;?></title>
  ...
  <!-- DataTables -->
	<link rel="stylesheet" type="text/css" href="{{asset('lte/lte/plugins/datatable/jquery.dataTables.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('lte/lte/plugins/datatable/jquery.dataTables.min.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('lte/lte/plugins/datatable/dataTables.bootstrap5.min.css')}}">

  <!-- Select2 -->
	<link rel="stylesheet" href="{{asset('lte/lte/plugins/select2/select2.min.css')}}">
  <link rel="stylesheet" href="{{asset('lte/lte/plugins/select2/select2-bootstrap4.min.css')}}">
...
<!-- Select2 -->
<script src="{{asset('lte/lte/plugins/select2/select2.full.min.js')}}"></script>

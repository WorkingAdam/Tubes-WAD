...
class LayananMemberController extends Controller
{
    ...
    public function store(Request $request) //=>> simpan layanan yang dipilih ke tabel order
    {
        ...
        foreach(Diamond::where('jumlah',$request->diamond)->get() as $dt):
            $harga = $dt['harga'];
        endforeach;
        ...
        return redirect()->route('member.layanan.checkout',$code);
    }
    ...
    public function checkout($id) // proses checkout order sesuai layanan yang dipesan
    {
        ...
        return view('member.layanan.checkout', $data);
    ...
    public function detail($id)
    {
        ...
        $data['members'] = Member::where('id',\Auth::user()->id)->get();
        return view('member.layanan.detail', $data);
    ...
    public function diamond(Request $request, $id)
    {
        //
    }
    ...
    public function batalorder($id)
    {
        ...
        $aksi->delete();
        return redirect()->route('member.layanan');
    }
    ...
    public function cetakinvoice($id)
    {
        ...
        //ambil data pemesan dari id user
        $data['members'] = Member::where('id',\Auth::user()->id)->get();
        return view('member.layanan.cetakinvoice', $data);
    }
}
